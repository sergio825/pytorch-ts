...
class TempFlowEstimator_mod(PyTorchEstimator):
    @validated()
    def __init__(
        self,
        input_size: int,
    ...
    def create_training_network(self, device: torch.device) -> TempFlowTrainingNetwork_mod:
    ...
    def create_predictor(
        ...
        trained_network: TempFlowTrainingNetwork_mod,
        device: torch.device,
    ) -> Predictor:
